...
- 파이류 7개 브랜드로 범위를 축소하여 분류 정확도 향상 기대
...
### 3.2 파이 브랜드 분류
- 검출된 상품 중 오리온 파이류 7개 브랜드 분류
- MobileNetV3 기반 7클래스 분류기
- confidence가 낮은 경우 "미분류" 처리
- 오분류가 심할 경우 "기타" 클래스 추가 검토
